...
export default function RegistroPage() {
  ...
  const validateAll = () => {
    const campos = ['nombre', 'email', 'password', 'telefono'];
    const nuevosErrors = {};
    let hayError = false;
    ...
    setTouched({ nombre: true, email: true, password: true, telefono: true });
    return !hayError;
  };
  ...
  const prefijoActual = PREFIJOS_TELEFONICOS.find(
    (p) => p.codigo === form.telefono_prefijo
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                placeholder={form.telefono_prefijo === '+57' ? '300 123 4567' : 'N\u00famero'}
                inputMode="numeric"
