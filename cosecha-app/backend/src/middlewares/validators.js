...
const fincaValidators = {
  crear: [
    ...
    body('latitud').optional({ nullable: true }).isFloat({ min: -90, max: 90 }).withMessage('Latitud invalida'),
    body('longitud').optional({ nullable: true }).isFloat({ min: -180, max: 180 }).withMessage('Longitud invalida'),
    validate,
  ],
};
